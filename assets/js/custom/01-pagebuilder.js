(function(){ 
    ...
    function addClasses() {
		jQuery('.page_section_class').each(function() {
			...
			jQuery(this).append('<button type="button" class="btn btn-primary mt-2 open-bootstrap-popup section-class" id="btn-'+$fieldid+'">Add Styles</button>');
    ...
    jQuery(document).on('click', 'button.open-bootstrap-popup', function(e){
